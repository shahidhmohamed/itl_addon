...
class LbxbiGpoH001(models.Model):
    _name = "lbx_bi_gpo_h001"
    _inherit =["mail.thread",'mail.activity.mixin']
    _description = "PO"
    _rec_name = 'PoNumber'

    get_po_lines = fields.One2many('lbx_bi_gpo_d001', 'PurchaseorderNum', string="PurchaseorderNum")
    ...
    def delete_records_from_related_model(self):
        ...
        gpo_d001_model = self.env['lbx_bi_gpo_d001']
    ...
    selected_vpo_details = fields.Many2one('lbx_bi_vpo_h001', string='SELECT VPO')
