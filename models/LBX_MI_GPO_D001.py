...
class LbxMiGpoI001(models.Model):
    _name = "lbx_mi_gpo_d001"
    
    PurchaseorderNum = fields.Many2one('lbx_mi_gpo_h001', string="PURCHASE ORDER NUMBER")
    ...
    def create(self, values):
        ...
        return super(LbxMiGpoI001, self).create(values)
