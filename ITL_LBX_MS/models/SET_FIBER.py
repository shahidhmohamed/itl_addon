...
class SetFiber(models.Model):
    ...
    # component 1
    Component_1 = fields.Many2one('sub_components', string='SELECT COMPONENT', store=True)
    Component_1_name = fields.Char(string='SELECTED COMPONENT', related='Component_1.ComponentName', readonly=True, store=True)

    component_1_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_1_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_1_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_1_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_1_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_1_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_1_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_1_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_1_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_1_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 2
    Component_2 = fields.Many2one('sub_components', string='SELECT COMPONENT', store=True)
    Component_2_name = fields.Char(string='SELECTED COMPONENT', related='Component_2.ComponentName', readonly=True, store=True)

    component_2_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_2_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_2_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_2_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_2_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_2_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_2_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_2_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_2_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_2_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 3
    Component_3 = fields.Many2one('sub_components', string='SELECT COMPONENT', store=True)
    Component_3_name = fields.Char(string='SELECTED COMPONENT', related='Component_3.ComponentName', readonly=True, store=True)

    component_3_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_3_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_3_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_3_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_3_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_3_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_3_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_3_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_3_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_3_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 4
    Component_4 = fields.Many2one('sub_components', string='SELECT COMPONENT')
    Component_4_name = fields.Char(string='SELECTED COMPONENT', related='Component_4.ComponentName', readonly=True, store=True)

    component_4_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_4_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_4_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_4_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_4_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_4_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_4_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_4_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_4_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_4_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 5
    Component_5 = fields.Many2one('sub_components', string='SELECT COMPONENT')
    Component_5_name = fields.Char(string='SELECTED COMPONENT', related='Component_5.ComponentName', readonly=True, store=True)

    component_5_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_5_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_5_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_5_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_5_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_5_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_5_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_5_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_5_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_5_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 6
    Component_6 = fields.Many2one('sub_components', string='SELECT COMPONENT')
    Component_6_name = fields.Char(string='SELECTED COMPONENT', related='Component_6.ComponentName', readonly=True, store=True)

    component_6_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_6_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_6_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_6_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_6_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_6_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_6_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_6_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_6_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_6_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 7
    Component_7 = fields.Many2one('sub_components', string='SELECT COMPONENT')
    Component_7_name = fields.Char(string='SELECTED COMPONENT', related='Component_7.ComponentName', readonly=True, store=True)

    component_7_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_7_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_7_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_7_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_7_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_7_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_7_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_7_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_7_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_7_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 8
    Component_8 = fields.Many2one('sub_components', string='SELECT COMPONENT')
    Component_8_name = fields.Char(string='SELECTED COMPONENT', related='Component_8.ComponentName', readonly=True, store=True)

    component_8_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_8_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_8_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_8_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_8_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_8_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_8_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_8_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_8_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_8_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 9
    Component_9 = fields.Many2one('sub_components', string='SELECT COMPONENT')
    Component_9_name = fields.Char(string='SELECTED COMPONENT', related='Component_9.ComponentName', readonly=True, store=True)

    component_9_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_9_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_9_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_9_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_9_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_9_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_9_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_9_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_9_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_9_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # component 10
    Component_10 = fields.Many2one('sub_components', string='SELECT COMPONENT', store=True)
    Component_10_name = fields.Char(string='SELECTED COMPONENT', related='Component_10.ComponentName', readonly=True, store=True)

    component_10_Fiber1 = fields.Many2one('sub_fiber', string='SELECT FIBER 1', store=True)
    ...
    component_10_Fiber2 = fields.Many2one('sub_fiber', string='SELECT FIBER 2', store=True)
    ...
    component_10_Fiber3 = fields.Many2one('sub_fiber', string='SELECT FIBER 3', store=True)
    ...
    component_10_Fiber4 = fields.Many2one('sub_fiber', string='SELECT FIBER 4', store=True)
    ...
    component_10_Fiber5 = fields.Many2one('sub_fiber', string='SELECT FIBER 5', store=True)
    ...
    component_10_Fiber6 = fields.Many2one('sub_fiber', string='SELECT FIBER 6', store=True)
    ...
    component_10_Fiber7 = fields.Many2one('sub_fiber', string='SELECT FIBER 7', store=True)
    ...
    component_10_Fiber8 = fields.Many2one('sub_fiber', string='SELECT FIBER 8', store=True)
    ...
    component_10_Fiber9 = fields.Many2one('sub_fiber', string='SELECT FIBER 9', store=True)
    ...
    component_10_Fiber10 = fields.Many2one('sub_fiber', string='SELECT FIBER 10', store=True)
    ...
    # FromFiber2 = fields.Many2one('composition_lines_tab_02', string='COMPOSITION 02')

    # Fcomposition = fields.Char(string='FINAL COMPOSITION' , compute = '_compute_final_composition')

    # @api.depends('discription01', 'FromFiber2')
    # def _compute_final_composition(self):
    #     for record in self:
    #         if record.discription01 and record.FromFiber2.discription:
    #             record.Fcomposition = f"{record.discription01} {record.FromFiber2.discription}"
    #         else:
    #             record.Fcomposition = record.discription01
