...
class LbxBivpoh001(models.Model):
    _name = "lbx_bi_vpo_h001"
    _inherit =["mail.thread",'mail.activity.mixin']
    _description = "VPO"
    _rec_name = 'Po_number_get'

    vpo_lines = fields.One2many('lbx_bi_vpo_d001', 'vpo_line_c', string="vpo_lines")
    ...
    def create(self, vals):
        ...
        return super(LbxBivpoh001, self).create(vals)
